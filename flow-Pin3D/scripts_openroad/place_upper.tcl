...
write_def $env(RESULTS_DIR)/$env(DESIGN_NAME)_3D.gp.def
write_verilog $env(RESULTS_DIR)/$env(DESIGN_NAME)_3D.gp.v

save_image -resolution 0.1 $::env(RESULTS_DIR)/place_upper.webp 
...
add_pdn_stripe -grid {grid} -layer {metal1} -width {0.17} -pitch {2.8} -offset {0} -followpins
...
add_pdn_stripe -grid {grid} -layer {metal19} -width {0.17} -pitch {2.8} -offset {0}

# M4 和 M7 使用动态计算的 pitch
add_pdn_stripe -grid {grid} -layer {metal16} -width {0.48} -pitch $m4_pitch -offset {2}
add_pdn_stripe -grid {grid} -layer {metal13} -width {1.40} -pitch $m7_pitch -offset {2}

# 连接各层
add_pdn_connect -grid {grid} -layers {metal19 metal16}
add_pdn_connect -grid {grid} -layers {metal16 metal13}

add_pdn_connect -grid {grid} -layers {metal7 metal13}
